...
local function FixPandariaWorldBossPins()
	...
	frame:SetScript("OnEvent", function()
	    C_Timer.After(2, function() PandariaMapFix_Initialize() end)
	end)
	...
	function PandariaMapFix_Initialize()
	    ...
	    WorldMapFrame:HookScript("OnShow", function()
	        C_Timer.After(0.2, function() PandariaMapFix_OnMapChanged() end)
	    end)
	    hooksecurefunc(WorldMapFrame, "SetMapID", function()
	        C_Timer.After(0.2, function() PandariaMapFix_OnMapChanged() end)
	    end)
	    WorldMapFrame.ScrollContainer:HookScript("OnMouseWheel", function()
	        C_Timer.After(0.05, function() PandariaMapFix_UpdatePositions() end)
	    end)
